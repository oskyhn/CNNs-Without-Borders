#!/usr/bin/python2 -utt
#-*- coding: utf-8 -*-
# This code is built from Anastasiya Mishchuk's repository](https://github.com/DagnyT/hardnet).
# Copyright (c) 2017 Anastasiya Mishchuk, Dmytro Mishkin.
# The repository is available under the MIT License.
#
# ==========================================================================================
# This implementation includes Full-Conv version. 
...
parser.add_argument('--batch-size', type=int, default=256, metavar='BS',# default=1024
                    help='input batch size for training (default: 1024)')
parser.add_argument('--test-batch-size', type=int, default=256, metavar='BST',# default=1024
...
class HardNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=3, padding=2, bias = False),
            nn.BatchNorm2d(32, affine=False),
            nn.ReLU(),
            nn.Conv2d(32, 32, kernel_size=3, padding=2, bias = False),
            nn.BatchNorm2d(32, affine=False),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=2, bias = False),
            nn.BatchNorm2d(64, affine=False),
            nn.ReLU(),
            nn.Conv2d(64, 64, kernel_size=3, padding=2, bias = False),
            nn.BatchNorm2d(64, affine=False),
            nn.ReLU(),
            nn.Conv2d(64, 128, kernel_size=3, stride=2,padding=2, bias = False),
            nn.BatchNorm2d(128, affine=False),
            nn.ReLU(),
            nn.Conv2d(128, 128, kernel_size=3, padding=2, bias = False),
            nn.BatchNorm2d(128, affine=False),
            nn.ReLU(),
            nn.Dropout(0.3),
...
def test(test_loader, model, epoch, logger, logger_test_name):
    ...
    del labels, label, data_p, data_a, out_a, out_p, distances, dists, ll
    return
