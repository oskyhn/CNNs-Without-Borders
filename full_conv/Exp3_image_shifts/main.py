...
#
# ==========================================================================================
# This implementation includes Same-Conv, BlurPool, Full-Conv and Full-Conv with BlurPool
...
parser.add_argument('--shift_inc', default=32, type=int,
                    help='increasing the shifting (default: 32)')
best_acc1 = 0
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if(args.no_data_aug):
        train_dataset = datasets.ImageFolder(
            traindir,
            transforms.Compose([
                transforms.Resize(256 + args.shift_inc), # to apply shifting of 64 pixels
    ...
    val_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(valdir, transforms.Compose([
            transforms.Resize(256 + args.shift_inc),
