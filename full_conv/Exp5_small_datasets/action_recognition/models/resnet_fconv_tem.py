...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.zero_pad_I = nn.ConstantPad3d((2,2,2,2,2,2),0) #  (padding_left, padding_right, padding_top , padding_bottom, padding_front, padding_back)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv2 = nn.Conv3d(
            planes, planes, kernel_size=3, stride=stride, padding=(2,2,2), bias=False)
        self.bn2 = nn.BatchNorm3d(planes)
